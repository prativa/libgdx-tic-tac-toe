...
public class WorldRender {
	...
	private void renderO() {
		...
		for(int i=0;i<worldhandler.PostionArrayY;i++){
			
			
			switch (worldhandler.PostionArrayY) {
			case 0:
				// due nothing :P
				break;
			case 1:
			...
			case 6:
				...
				break;
			case 7:
				shapeRenderer.circle(8.66f, 9.5f, 5,20);
				break;
			case 8:
				shapeRenderer.circle(25, 9.5f, 5,20);
				break;
			case 9:
				shapeRenderer.circle(41.5f, 9.5f, 5,20);
				break;
	...
	private void renderX(){
		...
		for(int i=0;i<worldhandler.PostionArrayX;i++){
			
		
		switch (worldhandler.PostionArrayX) {
		case 0:
			// due nothing :P
			break;
		case 1:
